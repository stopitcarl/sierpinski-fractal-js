...
var text_hint_full = "Description: Increase/Deacrease\n_________________\nNum of triangles: L / K\nCanvas size: I / U\nFullscreen: F\nStroke weight: T / Y\nTriangle size: G / H\nFading: V / B\nToggle text: D"
...
function draw() {
  ...
  if (active_text) {
    ...
    noStroke();
    if (keyIsDown(65)) { // If key "a" (65) is pressed
      fill(200);
      text(text_hint_full, 10, 30);
    } else {
      fill(100);
      text('Press a for help', 10, 30);
    }
    noFill();
  }
